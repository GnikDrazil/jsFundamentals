...
/*
    DOCUMENT OBJECT MODEL
        ...
        - DOM stands for Document Object Model, and it is what allows our JavaScript to interact with the HMTLand CSS of our webpage.The DOM specifies how browsers should create a model of an HTML page and how JavaScript can access and update the contents of a web page while it's in the browser window. 
             - The DOM is an object-oriented representation of a web page, which we can then modify with a scripting language like JavaScript. The DOM covers two primary areas:
                ...
                2. Access and changing tags and data in the HTML page
                    - the DOM provides methods and properties to access and update each object in the mode, which in turn updates what the user sees in the browser
...
allParagraphs[0].innerText = 'My test has chagned!'; // since querySelectorAll() returns a nodelist (array) of all of the specified elements, we can access a specific indice from that array, and change the value. 
...
/*
    INNERTEXT vs INNERHTML cs TEXTCONTENT
